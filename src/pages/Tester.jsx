...
const Home = () => {
    ...
    const initialTime = 0.05 * 60 * 60; //24 hours in seconds
    ...
    return (
        ...
        <div className="bg-pixelBlue">
            ...
            <div className=" flex ">
                ...
                <div className="flex-grow pt-28 justify-center">
                    ...
                    <div className="py-20 space-y-6">
                        {/* <h1>COUNTDOWN</h1> */}
                        <p className="text-pixelGreen text-center text-3xl">Hackathon ends in:</p>
                        <h2 className="text-pixelGreen text-center text-9xl">{formatTime(timeLeft)}</h2>
                        <p className="text-pixelGreen text-center text-3xl">Hackathon in Progress</p>
                    </div>
            ...
            <div className="py-2 flex justify-center items-center">
                <p onClick={googleFormsUrlClicker} className="text-1xl text-pixelYellow border-2 border-pixelYellow py-2 px-4 rounded-sm transition-colors duration-300 ease-in-out hover:text-pixelBlue hover:bg-pixelYellow">I Want To Register</p>
            </div>
            ...
            <div className="pt-6">
                <p className="text-pixelGreen text-1xl px-20 text-center">Welcome to the Pixel Codex Hackathon! This 72-hour coding marathon is a platform 
                    for you to showcase your creativity, technical skills, and collaborative spirit.
                     ...
                     and a chance to join our incubator program, this hackathon promises an adrenaline-filled
                      journey of innovation. Remember, it's not just about coding; it's about pushing your limits,
                       ...
                       Cheers to creativity and collaboration!</p>
            </div>
            
            <div className="pt-20">
                <p className="text-1xl text-pixelYellow px-20 text-center">Please make sure to read through the hackathon document and also join the community and 
                    get answers to any and all questions you might have about the Hackathon.</p>
            </div>

            <div className="flex justify-center items-center space-x-8 p-6">
                <p className="text-1xl border-2 border-pixelGreen rounded-sm py-2 px-4 text-pixelGreen transition-colors duration-300 ease-in-out hover:text-pixelYellow hover:border-pixelYellow">Join the community</p>
                <p className="text-1xl border-2 border-pixelGreen rounded-sm py-2 px-4 text-pixelGreen transition-colors duration-300 ease-in-out hover:text-pixelYellow hover:border-pixelYellow">Hackathon Document</p>
            </div>
            ...
            <div className="flex mx-32 pb-12 justify-between space-x-6">
                <div>
                    ...
                    <span> </span>
                    <span> </span>
                    <span className="text-1xl text-lg text-pixelGreen">2024</span>
                </div>
